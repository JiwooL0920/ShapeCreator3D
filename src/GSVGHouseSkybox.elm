module GSVGHouseSkybox exposing (main)
       ...
       [
        ...
        , case skyboxType of
            Skybox.URLSkybox top bottom side1 side2 side3 side4 ->
                fetchTextures [top, bottom, side1, side2, side3, side4]
            _ -> Cmd.none
       ]
    )
...
subscriptions model =
    Sub.batch
        ...
        ,
        -- subscriptions for the GSVG skybox
...
skyboxType = Skybox.GSVGSkybox True skyBoxTop skyBoxSides skyBoxBottom
                  ...
                  Scene3d.custom
                      ...
                      , entities =  [   plane
                                    ...
                                    , chair
                                        |> Scene3d.translateBy (Vector3d.centimeters -50 0 0)
                                    , parasol
                                    , Skybox.skybox (List.map Just texturesList) 90

                                  ]
                      }
                  , Html.map SkyboxMsg <| GS.drawSkybox skyboxDebug model.gSkyboxModel skyBoxTop skyBoxSides skyBoxBottom
                  ]
      Nothing ->
        Html.div [] [Html.text "Loading...", Html.map SkyboxMsg <| GS.drawSkybox False model.gSkyboxModel skyBoxTop skyBoxSides skyBoxBottom]
...
fetchTextures : List String -> Cmd Msg
fetchTextures textureList =
  textureList
