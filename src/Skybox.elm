...
roundSkybox texture size = 
    Scene3d.mesh (Material.texturedColor texture) (sphereMeshNoCulling size)
...
type SkyboxType msg =
      URLSkybox String String String String String String
    | GSVGSkybox Bool (Shape msg) (Shape msg) (Shape msg)